...
(function (exports,landing_ui_field_basefield,main_popup,main_core_events,landing_backend,landing_pageobject,main_core) {
	...
	function _templateObject() {
	  var data = babelHelpers.taggedTemplateLiteral(["<div>Base processor</div>"]);
	...
	var BaseControl = /*#__PURE__*/function (_EventEmitter) {
	  ...
	  babelHelpers.createClass(BaseControl, [{
	    ...
	    key: "isNeedSetValue",
	    value: function isNeedSetValue(value) {
	...
	function _templateObject3() {
	  var data = babelHelpers.taggedTemplateLiteral(["<input type=\"text\" name=\"hexInput\" value=\"", "\" class=\"landing-ui-field-color-hex-input\">"]);
	...
	function _templateObject2() {
	  var data = babelHelpers.taggedTemplateLiteral(["<div class=\"landing-ui-field-color-hex-preview\">", "</div>"]);
	...
	var Hex = /*#__PURE__*/function (_BaseControl) {
	  ...
	  function Hex() {
	    ...
	    _this.onInput = main_core.Runtime.debounce(_this.onInput.bind(babelHelpers.assertThisInitialized(_this)), 300);
	  ...
	  babelHelpers.createClass(Hex, [{
	    ...
	    value: function buildLayout() {
	      ...
	      return main_core.Tag.render(_templateObject$2(), this.getInput(), this.getButton());
	    }
	  }, {
	    key: "getInput",
	    value: function getInput() {
	      ...
	      return this.cache.remember('input', function () {
	        return _this2.previewMode ? main_core.Tag.render(_templateObject2(), Hex.DEFAULT_TEXT) : main_core.Tag.render(_templateObject3(), Hex.DEFAULT_TEXT);
	      });
	    }
	  }, {
	    key: "getButton",
	    value: function getButton() {
	      ...
	      return this.cache.remember('editButton', function () {
	        return _this3.previewMode ? main_core.Tag.render(_templateObject4()) : main_core.Tag.render(_templateObject5());
	      });
	    }
	  }, {
	    key: "onInput",
	...
	function _templateObject2$1() {
	  var data = babelHelpers.taggedTemplateLiteral(["<div class=\"landing-ui-field-color-spectrum-picker\"></div>"]);
	...
	var Spectrum = /*#__PURE__*/function (_BaseControl) {
	  ...
	  babelHelpers.createClass(Spectrum, [{
	    key: "buildLayout",
	    value: function buildLayout() {
	      return main_core.Tag.render(_templateObject$3(), this.getPicker());
	    }
	  }, {
	    key: "getPicker",
	...
	function _templateObject$4() {
	  var data = babelHelpers.taggedTemplateLiteral(["<div class=\"landing-ui-field-color-recent\"></div>"]);
	...
	var Recent = /*#__PURE__*/function (_EventEmitter) {
	  ...
	  function Recent() {
	    ...
	    _this.setEventNamespace('BX.Landing.UI.Field.Color.Recent');
	  ...
	  babelHelpers.createClass(Recent, [{
	    ...
	    value: function getLayoutContainer() {
	      return this.cache.remember('layout', function () {
	        return main_core.Tag.render(_templateObject$4());
	      });
	    }
	  }, {
	    key: "initItems",
	    ...
	    value: function buildItemsLayout() {
	      ...
	      Recent.items.forEach(function (item) {
	        if (isHex(item)) {
	          var itemLayout = main_core.Tag.render(_templateObject2$2(), item, item);
	...
	var Colorpicker = /*#__PURE__*/function (_BaseControl) {
	  ...
	  function Colorpicker(options) {
	    ...
	    main_core.Event.bind(_this.hexPreview.getLayout(), 'click', _this.onPopupOpenClick.bind(babelHelpers.assertThisInitialized(_this))); // popup
	  ...
	  babelHelpers.createClass(Colorpicker, [{
	    ...
	    key: "buildLayout",
	    value: function buildLayout() {
	      return main_core.Tag.render(_templateObject$5(), this.hexPreview.getLayout());
	    }
	  }, {
	    key: "getPopupContent",
	    value: function getPopupContent() {
	      return main_core.Tag.render(_templateObject2$3(), this.recent.getLayout(), this.hex.getLayout(), this.spectrum.getLayout(), this.getSelectButton(), this.getCancelButton());
	    }
	  }, {
	    key: "getSelectButton",
	    value: function getSelectButton() {
	      return this.cache.remember('selectButton', function () {
	        return main_core.Tag.render(_templateObject3$1(), main_core.Loc.getMessage('LANDING_FIELD_COLOR-BUTTON_SELECT'));
	      });
	    }
	  }, {
	    key: "getCancelButton",
	    value: function getCancelButton() {
	      return this.cache.remember('cancelButton', function () {
	        return main_core.Tag.render(_templateObject4$1(), main_core.Loc.getMessage('LANDING_FIELD_COLOR-BUTTON_CANCEL'));
	      });
	    }
	  }, {
	    ...
	    key: "onPopupOpenClick",
	    value: function onPopupOpenClick() {
	...
	var Primary = /*#__PURE__*/function (_EventEmitter) {
	  ...
	  babelHelpers.createClass(Primary, [{
	    ...
	    value: function getLayout() {
	      return this.cache.remember('layout', function () {
	        return main_core.Tag.render(_templateObject$6(), main_core.Loc.getMessage('LANDING_FIELD_COLOR-PRIMARY_TITLE'));
	      });
	    }
	  }, {
	    key: "getValue",
	...
	var Preset = /*#__PURE__*/function (_EventEmitter) {
	  ...
	  babelHelpers.createClass(Preset, [{
	    ...
	    value: function getLayout() {
	      ...
	      return this.cache.remember('layout', function () {
	        return main_core.Tag.render(_templateObject$7(), _this2.items.map(function (item) {
	    ...
	    value: function getItemLayout(name) {
	      ...
	      return this.cache.remember(name, function () {
	        ...
	        var item = main_core.Tag.render(_templateObject2$4(), style, name);
	...
	function _templateObject2$5() {
	  var data = babelHelpers.taggedTemplateLiteral(["<span class=\"landing-ui-field-color-presets-open\">\n\t\t\t\t", "\n\t\t\t</span>"]);
	...
	var PresetCollection = /*#__PURE__*/function (_EventEmitter) {
	  ...
	  function PresetCollection(options) {
	    ...
	    babelHelpers.defineProperty(babelHelpers.assertThisInitialized(_this), "presets", {});
	    babelHelpers.defineProperty(babelHelpers.assertThisInitialized(_this), "activeId", null);
	    _this.cache = new main_core.Cache.MemoryCache();
	    ...
	    _this.onPresetChangeGlobal = _this.onPresetChangeGlobal.bind(babelHelpers.assertThisInitialized(_this));
	    main_core_events.EventEmitter.subscribe('BX.Landing.UI.Field.Color.PresetCollection:onChange', _this.onPresetChangeGlobal);
	    return _this;
	  }
	  ...
	  babelHelpers.createClass(PresetCollection, [{
	    ...
	    key: "getGlobalActiveId",
	    value: function getGlobalActiveId() {
	    ...
	    value: function getPresetByItemValue(value) {
	      ...
	      for (var _id in this.presets) {
	        var preset = this.getPresetById(_id);
	    ...
	    value: function getLayout() {
	      ...
	      return this.cache.remember('value', function () {
	        return main_core.Tag.render(_templateObject$8(), main_core.Loc.getMessage('LANDING_FIELD_COLOR-PRESETS_TITLE'), _this4.getOpenButton());
	      });
	    }
	  }, {
	    key: "getOpenButton",
	    value: function getOpenButton() {
	      return this.cache.remember('openButton', function () {
	        return main_core.Tag.render(_templateObject2$5(), main_core.Loc.getMessage('LANDING_FIELD_COLOR-PRESETS_MORE'));
	      });
	    }
	  }, {
	    ...
	    value: function getPopupLayout() {
	      ...
	      return this.cache.remember('popupLayout', function () {
	        var layouts = main_core.Tag.render(_templateObject3$2(), main_core.Loc.getMessage('LANDING_FIELD_COLOR-PRESETS_MORE_COLORS'));
	    ...
	    value: function getPresetLayout(presetId) {
	      ...
	      return this.cache.remember(presetId + 'layout', function () {
	        return main_core.Tag.render(_templateObject4$2(), presetId, _this8.presets[presetId].items.map(function (item) {
	          return main_core.Tag.render(_templateObject5$1(), main_core.Type.isString(item) ? item : item.getStyleString());
	        }));
	      });
	    }
	  }, {
	    ...
	    key: "onPresetChangeGlobal",
	    value: function onPresetChangeGlobal(event) {
	...
	babelHelpers.defineProperty(PresetCollection, "globalActiveId", null);
	...
	var Reset = /*#__PURE__*/function (_EventEmitter) {
	  ...
	  babelHelpers.createClass(Reset, [{
	    ...
	    value: function getLayout() {
	      return this.cache.remember('layout', function () {
	        return main_core.Tag.render(_templateObject$9(), main_core.Loc.getMessage('LANDING_FIELD_COLOR-RESET_HINT'));
	      });
	    }
	  }, {
	    key: "onClick",
	...
	var Zeroing = /*#__PURE__*/function (_EventEmitter) {
	  ...
	  function Zeroing() {
	    ...
	    _this.setEventNamespace('BX.Landing.UI.Field.Color.Zeroing');
	  ...
	  babelHelpers.createClass(Zeroing, [{
	    ...
	    value: function getLayout() {
	      return this.cache.remember('layout', function () {
	        return main_core.Tag.render(_templateObject$a(), main_core.Loc.getMessage('LANDING_FIELD_COLOR-ZEROING_TITLE'));
	      });
	    }
	  }, {
	    key: "onClick",
	...
	function _templateObject2$6() {
	  var data = babelHelpers.taggedTemplateLiteral(["<div class=\"landing-ui-field-color-colorset-preset-container\"></div>"]);
	...
	var ColorSet = /*#__PURE__*/function (_BaseControl) {
	  ...
	  function ColorSet(options) {
	    ...
	    _this.colorpicker.subscribe('onChange', function (event) {
	      ...
	      if (_this.preset.isPresetValue(color)) {
	        _this.preset.setActiveValue(color);

	        _this.colorpicker.unsetActive();
	      } else if (_this.blackAndWhitePreset.isPresetValue(color)) {
	        _this.blackAndWhitePreset.setActiveValue(color);
	    ...
	    _this.presets.subscribe('onChange', function (event) {
	      _this.setPreset(_this.presets.getPresetById(event.getData().presetId));
	    });

	    _this.presets.addDefaultPresets();

	    var preset = _this.presets.getActivePreset();
	  ...
	  babelHelpers.createClass(ColorSet, [{
	    ...
	    value: function buildLayout() {
	      ...
	      return main_core.Tag.render(_templateObject$b(), this.presets.getLayout(), this.getPresetContainer(), this.blackAndWhitePreset.getLayout(), this.colorpicker.getLayout());
	    }
	  }, {
	    key: "getTitleLayout",
	    ...
	    value: function getPresetContainer() {
	      return this.cache.remember('presetContainer', function () {
	        return main_core.Tag.render(_templateObject2$6());
	      });
	    }
	  }, {
	    key: "setPreset",
	    ...
	    key: "getPresetsCollection",
	    value: function getPresetsCollection() {
	      return this.presets;
	    }
	  }, {
	    ...
	    value: function setValue(value) {
	      if (this.isNeedSetValue(value)) {
	        ...
	        var activePreset = this.presets.getGlobalActiveId() ? this.presets.getPresetById(this.presets.getGlobalActiveId()) : this.presets.getPresetByItemValue(value);
	...
	var Opacity = /*#__PURE__*/function (_BaseControl) {
	  ...
	  function Opacity(options) {
	    ...
	    _this.defaultOpacity = main_core.Type.isObject(options) && Reflect.has(options, 'defaultOpacity') ? options.defaultOpacity : Opacity.DEFAULT_OPACITY;
	    _this.document = landing_pageobject.PageObject.getRootWindow().document;
	    _this.onPickerDragStart = _this.onPickerDragStart.bind(babelHelpers.assertThisInitialized(_this));
	    _this.onPickerDragMove = _this.onPickerDragMove.bind(babelHelpers.assertThisInitialized(_this));
	    _this.onPickerDragEnd = _this.onPickerDragEnd.bind(babelHelpers.assertThisInitialized(_this));
	  ...
	  babelHelpers.createClass(Opacity, [{
	    key: "buildLayout",
	    value: function buildLayout() {
	      var layout = main_core.Tag.render(_templateObject$c(), this.getPicker(), this.getColorLayout());
	    ...
	    key: "setPickerPosByOpacity",
	    value: function setPickerPosByOpacity(opacity) {
	      opacity = Math.min(1, Math.max(0, opacity));
	      main_core.Dom.style(this.getPicker(), {
	        left: "".concat(100 - opacity * 100, "%")
	      });
	    }
	  }, {
	    key: "getLayoutRect",
	    ...
	    value: function getColorLayout() {
	      return this.cache.remember('colorLayout', function () {
	        return main_core.Tag.render(_templateObject2$7());
	      });
	    }
	  }, {
	    key: "getPicker",
	    ...
	    value: function getDefaultValue() {
	      ...
	      return this.cache.remember('default', function () {
	        return new ColorValue(Opacity.DEFAULT_COLOR).setOpacity(_this3.defaultOpacity);
	      });
	    }
	  }, {
	    key: "getValue",
	    value: function getValue() {
	      ...
	      return this.cache.remember('value', function () {
	        var pickerLeft = main_core.Text.toNumber(main_core.Dom.style(_this4.getPicker(), 'left'));
	        var layoutWidth = main_core.Text.toNumber(_this4.getLayout().getBoundingClientRect().width);
	        return _this4.getDefaultValue().setOpacity(1 - pickerLeft / layoutWidth);
	      });
	    }
	  }, {
	    key: "setValue",
	...
	babelHelpers.defineProperty(Opacity, "DEFAULT_OPACITY", 1);
	...
	function _templateObject4$3() {
	  var data = babelHelpers.taggedTemplateLiteral(["<div class=\"landing-ui-field-color-tabs-tab\">\n\t\t\t\t\t\t", "", "\n\t\t\t\t\t</div>"]);
	...
	function _templateObject$d() {
	  var data = babelHelpers.taggedTemplateLiteral(["<div class=\"landing-ui-field-color-tabs", "\"></div>"]);
	...
	var Tabs = /*#__PURE__*/function (_EventEmitter) {
	  ...
	  function Tabs() {
	    ...
	    _this.setEventNamespace('BX.Landing.UI.Field.Color.Tabs');
	  ...
	  babelHelpers.createClass(Tabs, [{
	    ...
	    value: function getLayout() {
	      ...
	      return this.cache.remember('layout', function () {
	        ...
	        var layout = main_core.Tag.render(_templateObject$d(), additional);

	        if (_this2.isBig) {
	          var head = main_core.Tag.render(_templateObject2$8());
	          var content = main_core.Tag.render(_templateObject3$4());
	          ...
	          _this2.tabs.forEach(function (tab) {
	            var tabLayout = main_core.Tag.render(_templateObject4$3(), tab.getTitle(), tab.getLayout());
	  ...
	  babelHelpers.createClass(Tab, [{
	    ...
	    value: function getTitle() {
	      ...
	      return this.cache.remember('title', function () {
	        return main_core.Tag.render(_templateObject5$2(), _this4.title);
	      });
	    }
	  }, {
	    key: "getLayout",
	    value: function getLayout() {
	      ...
	      return this.cache.remember('layout', function () {
	        return main_core.Tag.render(_templateObject6(), _this5.items.map(function (item) {
	...
	var Color = /*#__PURE__*/function (_BaseProcessor) {
	  ...
	  babelHelpers.createClass(Color, [{
	    ...
	    key: "buildLayout",
	    value: function buildLayout() {
	      return main_core.Tag.render(_templateObject$e(), this.colorSet.getLayout(), this.primary.getLayout(), this.tabs.getLayout());
	    }
	  }, {
	...
	function _templateObject4$4() {
	  var data = babelHelpers.taggedTemplateLiteral(["<span class=\"landing-ui-field-color-gradient-open-popup\"></span>"]);
	...
	function _templateObject3$5() {
	  var data = babelHelpers.taggedTemplateLiteral(["<div class=\"landing-ui-field-color-gradient-preset-container\"></div>"]);
	  ...
	  babelHelpers.createClass(Gradient, [{
	    ...
	    value: function getPopupContent() {
	      ...
	      return this.cache.remember('popupContainer', function () {
	        return main_core.Tag.render(_templateObject$f(), _this3.getRotateButton(), _this3.getSwapButton());
	      });
	    }
	  }, {
	    key: "buildLayout",
	    value: function buildLayout() {
	      ...
	      return main_core.Tag.render(_templateObject2$9(), this.getPresetContainer(), this.colorpickerFrom.getLayout(), this.getPopupButton(), this.colorpickerTo.getLayout(), this.getSwitchTypeButton());
	    }
	  }, {
	    ...
	    value: function getSwitchTypeButton() {
	      return this.cache.remember('switchTypeButton', function () {
	        return main_core.Tag.render(_templateObject5$3(), main_core.Loc.getMessage('LANDING_FIELD_COLOR-GRADIENT_SWITCH_TYPE'));
	      });
	    }
	  }, {
	    key: "getRotateButton",
	    value: function getRotateButton() {
	      return this.cache.remember('rotateButton', function () {
	        return main_core.Tag.render(_templateObject6$1(), main_core.Loc.getMessage('LANDING_FIELD_COLOR-GRADIENT_ROTATE'));
	      });
	    }
	  }, {
	    key: "getSwapButton",
	    value: function getSwapButton() {
	      return this.cache.remember('swapButton', function () {
	        return main_core.Tag.render(_templateObject7(), main_core.Loc.getMessage('LANDING_FIELD_COLOR-GRADIENT_SWAP'));
	      });
	    }
	  }, {
	    key: "setPreset",
	  ...
	  babelHelpers.createClass(BgColor, [{
	    ...
	    value: function setValue(value) {
	      ...
	      if (main_core.Type.isNull(value)) ; else if (isRgbString(value) || isHex(value) || isHslString(value) || isCssVar(value)) {
	        ...
	        var presets = this.colorSet.getPresetsCollection();
	        var activePreset = presets.getGlobalActiveId() ? presets.getPresetById(presets.getGlobalActiveId()) : presets.getPresetByItemValue(gradientValue);
	...
	var Image = /*#__PURE__*/function (_BaseControl) {
	  ...
	  babelHelpers.createClass(Image, [{
	    key: "buildLayout",
	    value: function buildLayout() {
	      return main_core.Tag.render(_templateObject$g(), this.imgField.getLayout(), this.sizeField.getLayout(), this.attachmentField.getLayout());
	    }
	  }, {
	    key: "onImageChange",
	...
	var Bg = /*#__PURE__*/function (_BgColor) {
	  ...
	  babelHelpers.createClass(Bg, [{
	    key: "buildLayout",
	    value: function buildLayout() {
	      return main_core.Tag.render(_templateObject$h(), this.bigTabs.getLayout());
	    }
	  }, {
	    key: "onColorSetChange",
	    value: function onColorSetChange(event) {
	    ...
	    value: function onOverlayChange(event) {
	      var overlayValue = event.getData().color;
	      ...
	      var imageValue = this.image.getValue();
