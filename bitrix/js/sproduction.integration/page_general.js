    ...
    <div class="card-body">
        ...
        <div class="form-group mb-3">
            ...
            <div class="radio radio-info mb-2">
                <input type="radio" v-model="fields.contacts_phonemail_mode" id="sync_products_delivery_add" value="">
                <label for="sync_products_delivery_add">{{ $t("page.SP_CI_GENERAL_MAIN_PHONEMAIL_MODE_ADD") }}</label>
            </div>
            <div class="radio radio-info mb-2">
                <input type="radio" v-model="fields.contacts_phonemail_mode" id="sync_products_delivery_replace" value="replace">
                <label for="sync_products_delivery_replace">{{ $t("page.SP_CI_GENERAL_MAIN_PHONEMAIL_MODE_REPLACE") }}</label>
            </div>
        </div>
        <div class="form-group mb-3">
            <label>{{ $t("page.SP_CI_GENERAL_MAIN_CRM_ORDERID_FIELD") }}</label>
            <b-form-select v-model="fields.crm_orderid_field" v-b-tooltip.hover :title="$t('page.SP_CI_GENERAL_MAIN_CRM_ORDERID_FIELD_HINT')">
...
<div class="card" v-bind:class="{ \'block-disabled\': state.active == false }" v-if="state.display">
    <div class="card-body">
        ...
        <div class="form-group mb-3">
            <div class="checkbox checkbox-info">
                <input type="checkbox" id="general_products_no_discounts" v-model="fields.products_no_discounts">
                <label for="general_products_no_discounts" v-b-tooltip.hover :title="$t('page.SP_CI_GENERAL_PRODUCTS_NO_DISCOUNTS_TOOLTIP')">{{ $t("page.SP_CI_GENERAL_PRODUCTS_NO_DISCOUNTS") }}</label>
            </div>
        </div>
        ...
        <div v-if="fields.products_sync_type != ''" class="form-group mb-3">
    ...
    <div class="card-body">
        ...
        <div class="form-group mb-2">
            ...
            <table class="table mb-3 table-params table-params-props table-bordered">
                ...
                <tbody>
                <tr v-for="iblock in info.iblocks">
