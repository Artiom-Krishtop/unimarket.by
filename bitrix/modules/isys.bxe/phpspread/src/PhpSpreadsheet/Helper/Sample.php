...
class Sample
{
    ...
    /**
     * Returns an array of all known writer.
     *
    ...
    public function getSamples()
    {
        // Populate writer
        $files = [];
        foreach (glob(realpath(__DIR__ . '/../../../writer') . '/*.php') as $file) {
            $info = pathinfo($file);
     ...
     */
    public function write(Spreadsheet $spreadsheet, $filename, array $writers = ['Xlsx'])
    {
