...
?>
<?if ($_GET["sort"] == "name" || $_GET["sort"] == "catalog_PRICE_1"){
	$arParams["ELEMENT_SORT_FIELD"] = $_GET["sort"];
	$arParams["ELEMENT_SORT_ORDER"] = $_GET["method"];
}?>
<p class='sort_bl'>
	Сортировать по:
	<a <?if ($_GET["sort"] == "name"):?> class="actived" <?endif;?> href="<?=$arResult["SECTION_PAGE_URL"]?>?sort=name&method=asc">Названию</a>
	|
	<a <?if ($_GET["sort"] == "catalog_PRICE_1"):?> class="actived" <?endif;?> href="<?=$arResult["SECTION_PAGE_URL"]?>?sort=catalog_PRICE_1&method=asc">Цене</a>
</p>
<?
