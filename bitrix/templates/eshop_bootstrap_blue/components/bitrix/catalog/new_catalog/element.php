		...
		if ($elementId > 0)
		{
			...
			if (!empty($recommendedData))
			{
				...
				)
				{
					?>
					<div class='row'>
						<div class='container wiev_prod_bl'>
								...
								"ACTION_VARIABLE" => "action_cpv",	// Название переменной, в которой передается действие
									...
									"LABEL_PROP_2" => array(	// Свойство меток товара
										0 => "",
									),
									"LABEL_PROP_MOBILE_2" => "",	// Свойства меток товара, отображаемые на мобильных устройствах
									...
									"PROPERTY_CODE_MOBILE_2" => array(	// Свойства товаров, отображаемые на мобильных устройствах
										0 => "",
									),
