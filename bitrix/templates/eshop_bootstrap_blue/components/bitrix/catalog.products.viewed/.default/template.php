...
?>
	...
	{ ?>
		<div class="prod_analog col-xs-12" data-entity="<?=$containerName?>">
			<div class="title_prod_esche">Ранее вы просматривали</div>
			<div id="slider_sw_related_upsell_widget-4" class="sw-woo-container-slider related-products responsive-slider clearfix loading" data-lg="4" data-md="4" data-sm="3" data-xs="2" data-mobile="1" data-speed="1000" data-scroll="1" data-interval="5000" data-autoplay="true">
				<div class="resp-slider-container">
					<div class="slider_prod_upsel_2 responsive  owl-carousel">
		<?
		$areaIds = array();
