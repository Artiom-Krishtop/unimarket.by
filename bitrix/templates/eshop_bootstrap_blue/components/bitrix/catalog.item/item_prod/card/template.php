...
<div class="item-img products-thumb" data-entity="image-wrapper">
	...
	<a href="<?=$item["DETAIL_PAGE_URL"]?>">
		<? $img = CFile::ResizeImageGet($item['PREVIEW_PICTURE']['ID'], array('width'=>195, 'height'=>195), BX_RESIZE_IMAGE_EXACT, true, false, false, 95); ?>
		<img src="<?=$img['src']?>" id="<?=$itemIds['PICT']?>" class="attachment-shop_catalog size-shop_catalog wp-post-image">
	</a>
