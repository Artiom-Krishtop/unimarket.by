...
<div class="catalog-section bx-<?=$arParams['TEMPLATE_THEME']?>" data-entity="<?=$containerName?>">
	<ul class="products-loop row grid clearfix" data-entity="items-row">
	<?
				...
				switch ($rowData['VARIANT'])
				{
					...
					case 2:
						?>
								...
								{
									?>
									<li class="item col-lg-4 col-md-4 col-sm-6 col-xs-6 post-1091 product type-product status-publish has-post-thumbnail product_cat-fashion product_cat-men  instock sale shipping-taxable purchasable product-type-simple">
