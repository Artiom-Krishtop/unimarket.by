...
if (empty($arResult['ERROR_MESSAGE']))
{
	...
	{
		$APPLICATION->IncludeComponent("bitrix:sale.gift.basket", "uni_cart", Array(
...
{ ?>
	<div id="basket-root" class="container">
		...
		<!-- <div class="revo_breadcrumbs">
			...
			<div class="breadcrumbs custom-font theme-clearfix" id="navigation">
				<?$APPLICATION->IncludeComponent("bitrix:breadcrumb", "new_bread", array(
						"START_FROM" => "0",
						"PATH" => "",
						"SITE_ID" => "-"
					),
		...
		<div class="woocommerce-message-empty" role="alert"><? ShowError($arResult['ERROR_MESSAGE']); ?></div>
	</div>
<? } ?>
