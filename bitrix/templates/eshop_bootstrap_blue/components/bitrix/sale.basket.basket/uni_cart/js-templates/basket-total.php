				...
				<div class="basket-coupon-block-field">
					<div class="form">
						<div class="form-group" style="position: relative;">
							<input type="text" class="form-control input_coupon" id="" placeholder="Код купона" data-entity="basket-coupon-input">
					...
					<div class="basket-checkout-block-total-price-inner">
						{{#DISCOUNT_PRICE_FORMATED}}
							<div class="basket-coupon-block-total-price-difference">
								<strong><?=Loc::getMessage('SBB_BASKET_ITEM_ECONOMY')?></strong>
						...
						<div class="basket-coupon-block-total-price-current">
							...
							<span data-entity="basket-total-price" style='font-size: 18px; color: #0e6ed1;'>{{{PRICE_FORMATED}}}</span>
						</div>
					</div>
				</div>
